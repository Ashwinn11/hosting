...
interface SEOProps {
  ...
  ogImage?: string;
  appId?: string;
  appName?: string; // exact App Store listing name for JSON-LD + app meta; falls back to the title's first segment
  appStoreUrl?: string;
  appCategory?: string;
...
const SEOBox: React.FC<SEOProps> = ({
  title, description, keywords, ogImage, appId, appName: appNameProp, appStoreUrl, appCategory,
  ...
  useEffect(() => {
    ...
    const appName = appNameProp || title.split('|')[0].trim();
  ...
  }, [title, description, keywords, ogImage, appId, appNameProp, appStoreUrl, appCategory, aggregateRating, faqs, appNumericId, screenshots, breadcrumbs, pageType, canonicalUrl, datePublished, comparisonTable]);
