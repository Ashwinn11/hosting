...
export const pseoPages: PSEOPage[] = [
  ...
  
  {
    ...
    intro: "Day One and Honestly: Morning Journal are both journaling apps for iPhone, but they're built for entirely different purposes. Day One is a comprehensive long-form journal — a diary, a memory keeper, a photo journal. Honestly is a structured morning ritual tool — a 3-step sequence (mood, a free-write, and affirmations) that clears your head before the day gets loud, with app blocking to make sure you actually do it. If you're looking for a Day One alternative to build a morning routine, this comparison is for you.",
    sections: [
      {
        heading: 'Journaling Approach',
        body: "Day One gives you a blank canvas: write as much or as little as you want, attach photos, add location data, tag entries, and search your history going back years. It's the best long-form journaling app on iPhone, full stop. Honestly also gives you a genuinely blank page for the writing step — no prompts, no rules — but wraps it in a structure: a mood check-in first, then the free-write, then a few affirmations in your own words. The structure is the point — you're building a consistent under-3-minute morning ritual, not writing a memoir.",
      },
      {
        heading: 'App Blocking',
        body: "Day One has no app blocking features. Honestly Premium uses iOS Screen Time to lock your chosen apps until you complete your morning ritual. This is the biggest practical difference for people trying to build a morning routine. If you reach for your phone and open Instagram before getting out of bed, no journaling app will help — unless it locks the apps you're trying to avoid. Honestly does.",
      },
      {
        heading: 'Home Screen Widgets',
        body: "Day One has static reminder widgets. Honestly surfaces today's affirmation — in your own words, not a stock quote — right on your Lock Screen and Home Screen, updating as you complete your ritual. The widget integration makes your morning progress visible throughout the day, reinforcing the habit.",
      },
      {
        heading: 'iCloud Sync and Privacy',
        body: "Both apps sync via iCloud. Day One also offers end-to-end encrypted sync through their own servers. Honestly stores journal data locally on-device, with Premium adding iCloud sync — no third-party servers, no analytics, no tracking. For users concerned about the privacy of their personal reflections, Honestly's local-first approach is reassuring.",
      },
    ],
    comparisonTable: [
      { feature: 'Structured morning ritual', app: 'Yes (3-step)', competitor: 'No (free-form)' },
      { feature: 'App blocking', app: 'Yes (Premium)', competitor: 'No' },
      { feature: 'Lock Screen & widgets', app: 'Yes', competitor: 'Basic reminder only' },
      { feature: 'Long-form journaling', app: 'Basic', competitor: 'Yes (primary feature)' },
      { feature: 'Photo journal', app: 'No', competitor: 'Yes' },
      { feature: 'iCloud sync', app: 'Yes (Premium)', competitor: 'Yes' },
      { feature: 'Streak tracking', app: 'Yes', competitor: 'No' },
    ],
    faqs: [
      { question: 'Is Honestly a good Day One alternative?', answer: 'Honestly: Morning Journal is a Day One alternative optimized for morning routines. It structures your session into 3 steps (mood, a free-write, and affirmations), adds an app-blocking gate, and surfaces today\'s affirmation on your Lock Screen and Home Screen — features Day One does not have.' },
  ...
  },
  {
    ...
    sections: [
      {
        ...
        body: 'Day One encourages depth: long entries, photos, timelines, and archival quality. Honestly encourages brevity: a mood check, a genuinely blank page with no prompt, a few affirmations, and done. Day One is for journalers; Honestly is for people building a habit.',
      },
      {
      ...
      },
      {
        ...
        body: 'Day One requires subscription for syncing across devices. Honestly is free to start, with a one-time Lifetime purchase or monthly Premium unlocking the rest. Day One supports Mac/iPad; Honestly is iPhone-focused. Choose based on whether you need multi-device sync or app blocking.',
      },
    ],
    comparisonTable: [
      { feature: 'Mood check-in built in', app: 'Yes', competitor: 'No' },
      { feature: 'App blocking until you journal', app: 'Yes (Premium)', competitor: 'No' },
    ...
    faqs: [
      ...
      { question: 'Which app is better for morning routines?', answer: 'Honestly is built for morning routines with a structured ritual (mood, a free-write, and affirmations) and an app-blocking gate. Day One is better for flexible, unstructured journaling.' },
  ...
  
  {
    ...
    intro: 'A morning journaling practice can change your entire day. But starting one feels overwhelming. Five pages? Bullet points? How long should it take? Honestly is designed around the science of effective morning routines: a mood check-in, a genuinely blank page with no prompt, and a few affirmations to yourself — completed in under three minutes. This guide walks through why morning journaling works and how to build the habit.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'Blank page syndrome kills routines for some people — but for others, a prompt is just another question to answer instead of a feeling to get out. Honestly picks the second path deliberately: no prompts, no rotating questions. You pick your mood first, so you\'re not starting from nothing, then the page is genuinely blank. Write whatever\'s actually there, even if it\'s one line.',
      },
      {
    ...
    faqs: [
      ...
      { question: 'What should I journal about each morning?', answer: 'There\'s no prompt to answer. Pick your mood first, then write whatever\'s actually on your mind — Honestly deliberately gives you a blank page instead of a question. Finish with a couple of affirmations to yourself. Mood, free-write, affirm — that\'s the whole ritual.' },
  ...
  
  {
    ...
    intro: 'Phone addiction starts the moment you wake up. Before your coffee, before a thought, you\'re scrolling. That first 30 minutes sets the tone for your whole day. Honestly Premium breaks that cycle by locking your apps until you\'ve had a few minutes to yourself.',
    sections: [
      {
      ...
      {
        heading: 'The Under-3-Minute Intervention',
        body: 'A mood check, a free-write, and a couple of affirmations before your apps unlock. That\'s enough to interrupt the addiction cycle. You take control instead of your phone taking you. After weeks of locked apps, the ritual becomes automatic.',
      },
      {
        heading: 'Build a New Morning Identity',
        body: 'Instead of "person who scrolls at 6am," you become "person who journaled at 6am." Identity shifts happen through repeated behavior. Honestly Premium\'s app blocking forces the behavior; identity follows.',
      },
    ],
    faqs: [
      ...
      { question: 'What if I really need to check my phone?', answer: 'Honestly Premium locks recreational apps — Instagram, TikTok, games, whatever you choose. Calls, texts, email, and maps still work. Real emergencies get through.' },
      { question: 'Can I use Honestly if I don\'t like journaling?', answer: 'Honestly isn\'t a journal app in the traditional sense. It\'s a mood check-in, a genuinely blank page with no prompt, and a few affirmations to yourself. No essay required. Just reflecting.' },
    ],
  ...
  
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Mood check → a genuinely blank page, no prompt → a few affirmations to yourself. Naming the mood first (Awful or Cry, if that\'s where you are) makes the free-write easier to start, and closing with affirmations reframes catastrophizing into something steadier.',
      },
      {
  ...
  
  {
    ...
    metaDescription: 'Build morning habits with Honestly. Mood check-in, a genuinely blank page, affirmations, and Premium app blocking until you journal.',
    targetKeyword: 'best morning routine habit app',
    intro: 'Morning routines fail because you don\'t have accountability. You skip, feel guilty, then give up. Honestly makes morning routines stick with a simple, fixed ritual and — with Premium — app blocking until you\'ve written.',
    sections: [
      {
        heading: 'Accountability Through App Blocking',
        body: 'Other apps just remind you. Honestly Premium blocks apps until you journal. You can\'t procrastinate—your phone is locked until the ritual is done.',
      },
      {
        heading: 'A Ritual, Not a Checklist',
        body: 'Honestly doesn\'t chain together a growing list of habits — it keeps the same three steps every morning: mood, a free-write, affirmations. That repetition is the point. A day streak and a month-at-a-glance calendar give you the momentum a longer checklist would only complicate.',
      },
      {
        heading: 'A Blank Page, On Purpose',
        body: 'Blank page paralysis kills routines for some people — for others, a guided prompt is one more thing to overthink. Honestly picks a genuinely blank page on purpose: pick your mood first, so you\'re not starting cold, then write whatever\'s actually there.',
      },
    ],
    faqs: [
      { question: 'How do I actually stick to a morning routine?', answer: 'With accountability. Honestly Premium blocks your phone until you complete your ritual. It\'s harder to skip when you literally can\'t scroll.' },
      { question: 'What if I miss a day?', answer: 'Your streak resets but you don\'t fall off. The next day is a fresh start. Honestly tracks your best streak alongside your current one, not just perfect runs.' },
      { question: 'Can I customize my routine?', answer: 'The ritual itself is deliberately fixed — mood, a free-write, affirmations — every morning. What changes is entirely up to you: your mood, what you write, and which apps you choose to keep asleep until you\'re done.' },
    ],
  ...
  
  {
    ...
    metaDescription: 'Honestly journaling app helps with anxiety through a genuinely blank page — no prompts. Morning ritual, mood tracking, and affirmations proven to lower stress.',
    targetKeyword: 'best anxiety journaling app',
    intro: 'Anxiety lives in avoidance. You avoid the thought, it grows. Journaling disrupts that cycle by bringing anxious thoughts into the light. Honestly is a strong anxiety journaling app because it gets out of your way — mood check-in first (Awful and Cry are both real options), then a genuinely blank page, no prompts to overthink.',
    sections: [
      {
        heading: 'Journaling Disrupts Anxiety Spirals',
        body: 'When you journal about anxiety, something shifts. The thought goes from repetitive and scary to specific and manageable. Honestly\'s mood-first, prompt-free page gives that shift somewhere to happen — you\'re not answering a question, you\'re emptying your head.',
      },
      {
        heading: 'Morning Rituals Prevent All-Day Anxiety',
        body: 'Starting your day with intention—mood check, a free-write, a few affirmations—sets your nervous system to calm before stress hits. This single ritual reduces all-day anxiety.',
      },
      {
        heading: 'App Blocking Removes Anxiety Triggers',
        body: 'Social media and news feeds amplify anxiety. Honestly Premium blocks them until you journal. Remove the trigger, then navigate the day with a clear head.',
      },
    ],
    faqs: [
      ...
      { question: 'What should I journal about when anxious?', answer: 'Whatever\'s actually true — Honestly doesn\'t hand you a structure to fill in, just a blank page after you\'ve named your mood. If it helps, try naming the worry specifically, what\'s in your control, and one action you can take; the page is yours to use however works.' },
  ...
  
  {
    ...
    type: 'guide',
    title: 'Best App for Daily Affirmations & Gratitude 2026 — Honestly',
    h1: 'Best App for Daily Affirmations — A Gratitude-Adjacent Morning Habit',
    metaDescription: 'Honestly isn\'t a dedicated gratitude journal — it\'s a daily affirmation ritual: mood check-in, a free-write, and a few things you say to yourself, with streak tracking and Premium app blocking.',
    targetKeyword: 'best gratitude app',
    intro: 'Gratitude practice rewires your brain for happiness, and affirmations work through a similar mechanism — deliberately naming something good instead of waiting to notice it. Honestly isn\'t a dedicated gratitude journal, but its daily affirmation step scratches a very similar itch: up to five things you choose to say to yourself, in your own words, every morning.',
    sections: [
      {
        heading: 'Affirmations Are Neuroplasticity, Too',
        body: 'Noticing — or deciding — what\'s good literally rewires your brain to look for good. Daily practice makes this automatic, whether the words are gratitude ("I\'m grateful for...") or affirmation ("I am...").',
      },
      {
        heading: 'Specificity Matters',
        body: '"I\'m fine" is generic. "I am proud of getting this far" is specific and powerful. Honestly doesn\'t prompt you toward specificity — the affirmation box is simply blank — so it\'s on you to make it count.',
      },
      {
        heading: 'Streaks Create Momentum',
        body: 'A visible day streak changes your baseline happiness over weeks. You notice good things automatically, and Honestly\'s Home tab keeps the streak in view every morning.',
      },
    ],
    faqs: [
      { question: 'Is Honestly a dedicated gratitude journal?', answer: 'Not exactly. Honestly\'s morning ritual ends with affirmations — things you say to yourself — rather than a "three things I\'m grateful for" list. The mechanism is similar: deliberately naming something positive instead of waiting to notice it.' },
      { question: 'Does affirmation or gratitude journaling actually work?', answer: 'Yes. Research shows both practices increase happiness, reduce anxiety, and improve sleep when done consistently.' },
      { question: 'How specific should my affirmations be?', answer: 'Very. "I\'m proud of getting through today" beats "I did fine." Honestly leaves the box blank on purpose, so specificity is entirely up to you.' },
      { question: 'When should I write my affirmations?', answer: 'Right after your free-write, as the last step of the morning ritual. With Premium, your chosen apps stay asleep until you\'ve done it.' },
    ],
    cta: 'Start Your Affirmations',
    datePublished: '2026-06-13',
  },
  {
    appId: 'yumeship',
